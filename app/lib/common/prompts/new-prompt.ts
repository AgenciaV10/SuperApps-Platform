...
<technology_preferences>
  ...
  - Prefer client-side storage (localStorage/IndexedDB). Only use Supabase if user explicitly asks or is already connected
...
<database_instructions>
  CRITICAL: Prefer client-side persistence (localStorage/IndexedDB). Only use Supabase if explicitly requested, and never block when not connected.

  Supabase project setup handled separately by user. If not connected, DO NOT ask to connect; implement localStorage-based persistence. ${
    supabase
